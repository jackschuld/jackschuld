...
class _Performance {
  ...
  measure(measureName, startOrMeasureOptions, endMark) {
    ...
    if (typeof startOrMeasureOptions === "string") {
      ...
      start = Number.parseFloat(startOrMeasureOptions?.start) || performance$1.now();
      end = Number.parseFloat(startOrMeasureOptions?.end) || performance$1.now();
    }
...
const performance$1 = globalThis.performance || new Performance();
...
_global.performance = _global.performance || performance$1;
